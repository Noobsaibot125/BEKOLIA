...
const services = [
  { icon: <FaBug size={32} />, name: 'Désinsectisation', desc: 'Élimination complète de tous les insectes nuisibles', color: 'from-blue-500 to-blue-700', link: '/services' },
  { icon: <GiMouse size={32} />, name: 'Dératisation', desc: 'Éradication efficace des rongeurs par professionnels', color: 'from-green-500 to-green-700', link: '/services' },
  { icon: <FaLeaf size={32} />, name: 'Désinfection', desc: 'Assainissement complet par brumisation ou pulvérisation', color: 'from-teal-500 to-teal-700', link: '/services' },
  { icon: <GiAmberMosquito size={32} />, name: 'Anti-Moustiques', desc: 'Brumisation thermique et ULV contre les moustiques', color: 'from-purple-500 to-purple-700', link: '/services' },
  { icon: <GiWorms size={32} />, name: 'Termites', desc: 'Protection anti-termites, traitement curatif et préventif', color: 'from-orange-500 to-orange-700', link: '/services' },
  { icon: <FaShieldAlt size={32} />, name: 'Fumigation', desc: 'Traitement par fumigation pour espaces clos', color: 'from-red-500 to-red-700', link: '/services' },
];
...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      {/* ===== HERO avec fond CSS animé premium ===== */}
            ...
            >
              <motion.div variants={fadeUp} className="mb-8 flex justify-center">
                <span className="inline-flex items-center gap-2 bg-green-500/20 text-green-300 border border-green-400/30 text-sm font-bold px-5 py-2.5 rounded-full backdrop-blur-sm">
                  ...
                  Service N°1 en Côte d'Ivoire – Disponible 7j/7
                </span>
              </motion.div>
              ...
              <motion.p variants={fadeUp}
                ...
                Experts en <strong className="text-white">fumigation, brumisation, désinsectisation</strong> et dératisation à Abidjan.
                Intervention en moins d'1 heure. Résultats <strong className="text-white">garantis</strong>.
              </motion.p>
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap justify-center items-center gap-x-10 gap-y-6 mt-16 py-8 border-t border-white/10">
                <div className="flex items-center gap-3 text-white/90 group cursor-default">
                  ...
                  <span className="text-sm font-medium">Produits certifiés</span>
                </div>
                <div className="flex items-center gap-3 text-white/90 group cursor-default">
                  <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center text-green-400 border border-green-500/30 group-hover:bg-green-500 group-hover:text-white transition-all">
                    <FaShieldAlt />
                ...
                <div className="flex items-center gap-3 text-white/90 group cursor-default">
                  ...
                  <span className="text-sm font-medium">2500+ clients satisfaits</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((s, i) => (
                <motion.div key={i} variants={fadeUp}>
                  <Link to={s.link} className="card block p-8 group h-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-5 shadow-premium">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-lg">98%</p>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-black text-primary mb-6">
                L'Expert de Confiance pour votre Sécurité
              </h2>
              <p className="text-gray-500 mb-8 leading-relaxed">
                Depuis 10 ans, BEKOLIA protège les familles et entreprises d'Abidjan contre les nuisibles.
                Notre équipe de professionnels qualifiés utilise des méthodes éprouvées et des produits
                homologués pour des résultats durables.
              </p>
      ...
      <section className="py-20 bg-premium relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          ...
          >
            Besoin d'une Désinsectisation<br />Immédiate ?
          </motion.h2>
          <p className="text-blue-100 text-xl mb-12 max-w-2xl mx-auto">
            Nos techniciens interviennent chez vous en moins de 60 minutes. 
            Éliminez définitivement les nuisibles avec nos solutions garanties.
          </p>
